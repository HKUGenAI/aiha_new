# https://github.com/opendatalab/PDF-Extract-Kit/blob/main/pdf_extract_kit/utils/visualization.py
...
def visualize_bbox(image_path, bboxes, classes, scores, id_to_names, alpha=0.3):
    ...
    for i, bbox in enumerate(bboxes):
        ...
        cv2.putText(image, text, (x_min, y_min - 5), cv2.FONT_HERSHEY_SIMPLEX, 0.3, (255, 255, 255), 1)
